...
translations.ru = translations.ru || {
  ...
  "hero.subtitle":
  "От сырой телеметрии — к реальному исполнению: подключайте активы, описывайте логику — MITE управляет операциями. " +
  "Каждое выполненное действие фиксируется в системе и используется для следующего решения, правила и улучшения.",
