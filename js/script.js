    const translations = {
      en: {
        ...
        "about.title": "The flexible Industrial IoT platform that grows with your processes",
        "about.text":
          "Most IoT platforms stop at dashboards. MITE goes further: you orchestrate devices, model complex business logic, and push decisions back to the shop floor from one environment. No hard limits on data volume, device types, or workflows.",
      ...
      ru: {
       ...
       "hero.subtitle":
        ...
        "hero.metricText":
          "Рост объёма данных решается масштабированием, а не переписыванием системы.",

        // ABOUT / POSITIONING
        "about.eyebrow": "Позиционирование",
        "about.title": "Гибкая IIoT-платформа, которая растёт вместе с процессами",
        "about.text":
          "Большинство IoT-решений заканчиваются дашбордами. MITE идёт дальше: вы управляете устройствами, моделируете сложную бизнес-логику и возвращаете решения обратно в цех — из единой среды. Без жёстких ограничений по объёму данных, типам устройств и сценариям.",
        ...
        "pricing.subtitle":
          "Порог входа для экспериментов и расширяемые опции для масштабных внедрений.",
        ...
        "pricing.plan3.name": "Enterprise / OEM",
        "pricing.plan3.tagline":
          "Когда MITE становится ядром вашей цифровой инфраструктуры.",
        ...
        "faq.subtitle":
          "Минимум маркетинга, максимум ответов про интеграцию, безопасность и владение данными.",
        ...
        // FOOTER
        "footer.note":
          "MITE — промышленная IoT-платформа для команд, которые считают эффект в деньгах.",
      ...
      uk: {
        ...
        "hero.metricText":
          "Зростання обсягу даних вирішується масштабуванням, а не переписуванням системи.",

        // ABOUT / POSITIONING
        "about.eyebrow": "Позиціонування",
        "about.title":
          "Гнучка IIoT-платформа, що розвивається разом із бізнес-процесами",
        "about.text":
          "Більшість IoT-рішень обмежуються дашбордами. MITE йде далі: ви керуєте пристроями, моделюєте складну бізнес-логіку і повертаєте рішення назад у цех — з єдиної платформи.",

        // HIGHLIGHTS
        "highlights.eyebrow": "Що відрізняє MITE",
        "highlights.title": "Єдина платформа для пристроїв, логіки та аналітики",
        "highlights.subtitle":
          "MITE створена для промислових команд, яким потрібно експериментувати, масштабуватися та контролювати дані і процеси.",

        "highlight.logic.tag": "Бізнес-логіка",
        "highlight.logic.title": "Будь-яка складність процесів",
        "highlight.logic.text":
          "Опишіть сценарій словами та налаштуйте його без коду. Логіка може змінюватися так само швидко, як і операційні процеси.",
        "highlight.logic.meta": "Якщо процес можна описати, його можна реалізувати в MITE.",

        "highlight.protocols.tag": "Промислові протоколи",
        "highlight.protocols.title": "Різні типи обладнання та вендори",
        "highlight.protocols.text":
          "Підключайте ПЛК, лічильники, датчики й контролери через промислові та веб-протоколи. Один раз нормалізуйте дані і використовуйте їх у різних рішеннях.",
        "highlight.protocols.meta": "Modbus, LoRa, TCP/UDP, BLE, CAN та інші.",

        "highlight.scaling.tag": "Масштабування",
        "highlight.scaling.title": "Готовність до великих обсягів даних",
        "highlight.scaling.text":
          "Розвивайтеся від пілотів до десятків і сотень майданчиків, нарощуючи потужності, а не повністю змінюючи архітектуру.",
        "highlight.scaling.meta": "Горизонтальне масштабування без радикальних змін.",

        "highlight.insights.tag": "Аналітика",
        "highlight.insights.title": "Ключові інсайти на одному екрані",
        "highlight.insights.text":
          "Створюйте дашборди за лічені хвилини, поєднуйте дані MITE та інших систем. Бачите не тільки показники, а й контекст виробництва.",
        "highlight.insights.meta": "Від моніторингу до глибокого аналізу даних.",

        "highlight.open.tag": "Відкритість",
        "highlight.open.title": "Відкритий API та інтеграції",
        "highlight.open.text":
          "Використовуйте MITE як базовий рівень для ERP, MES, SCADA та власних застосунків. Ви контролюєте логіку та володієте даними.",
        "highlight.open.meta": "Ваша інфраструктура — ваші правила.",

        "highlight.cost.tag": "Цінність",
        "highlight.cost.title": "IoT як інвестиція",
        "highlight.cost.text":
          "Фокус на результаті: менше інцидентів, швидше впровадження, більше користі з кожного пристрою.",
        "highlight.cost.meta": "Окупність проекту у фокусі.",

        // USE CASES
        "use.eyebrow": "Сценарії",
        "use.title": "Від PoC до портфеля IIoT-рішень",
        "use.subtitle":
          "Почніть з одного сценарію та пере використовуйте платформу, модель даних і конектори для наступних ініціатив.",

        "use.card1.title": "Смарт-облік та сервісні мережі",
        "use.card1.text":
          "Консолідуйте дані з лічильників та сенсорів, виявляйте аномалії, зменшуйте втрати і формуйте прозору звітність для бізнесу.",
        "use.card1.pill1": "Енергія та вода",
        "use.card1.pill2": "Виявлення втрат",

        "use.card2.title": "Підключені активи та обладнання",
        "use.card2.text":
          "Відстежуйте стан критичних активів, режими роботи та умови експлуатації. Автоматизуйте процеси обслуговування та контролю якості.",
        "use.card2.pill1": "Моніторинг стану",
        "use.card2.pill2": "ТО та сервіс",

        "use.card3.title": "Галузеві рішення на MITE",
        "use.card3.text":
          "Створюйте рішення для фарми, харчової промисловості, виробництва чи інфраструктури на спільній платформі з мінімумом повторної роботи.",
        "use.card3.pill1": "Регульовані галузі",
        "use.card3.pill2": "White-label та OEM",

        // HOW IT WORKS
        "how.eyebrow": "Як це працює",
        "how.title": "Три кроки від пристрою до дії",
        "how.subtitle":
          "MITE поєднує реальний світ пристроїв і цифровий рівень аналітики та бізнес-правил.",

        "how.step1.tag": "Крок 1",
        "how.step1.title": "Підключення і моделювання інфраструктури",
        "how.step1.text":
          "Підключення пристроїв, шлюзів і контролерів займає хвилини. Сайти, цехи та активи описуються у зрозумілій структурі.",

        "how.step2.tag": "Крок 2",
        "how.step2.title": "Налаштування бізнес-логіки",
        "how.step2.text":
          "Визначте правила, пороги, завдання та маршрути обробки без програмування. Легко коригуйте логіку під зміни операцій.",

        "how.step3.tag": "Крок 3",
        "how.step3.title": "Аналітика та зворотній зв'язок у поле",
        "how.step3.text":
          "Створюйте дашборди, діагностуйте проблеми та запускайте дії в реальному середовищі. Тестуйте нові ідеї без багатомісячних проектів.",

        // PRICING
        "pricing.eyebrow": "Тарифи",
        "pricing.title": "Для пілотів, масштабування та корпоративних клієнтів",
        "pricing.subtitle":
          "Зрозумілі входи для експериментів та гнучкі опції для масштабних впроваджень.",

        "pricing.plan1.label": "Для пілотів",
        "pricing.plan1.name": "Start",
        "pricing.plan1.tagline": "Для перевірки IoT-ідей та невеликих PoC.",
        "pricing.plan1.price": "Від €9.99 / міс",
        "pricing.plan1.note": "Обмежена кількість пристроїв, доступ до основних функцій.",
        "pricing.plan1.li1": "Швидкий запуск і базові дашборди",
        "pricing.plan1.li2": "Підтримка стандартних протоколів",
        "pricing.plan1.cta": "Запустити пілот",

        "pricing.plan2.label": "Для зростаючих проектів",
        "pricing.plan2.name": "Scale",
        "pricing.plan2.tagline":
          "Коли успішний пілот потрібно розгорнути на декількох майданчиках.",
        "pricing.plan2.price": "Від €99 / міс",
        "pricing.plan2.note": "Баланс кількості пристроїв, функцій і підтримки.",
        "pricing.plan2.li1": "Розширена бізнес-логіка та сценарії",
        "pricing.plan2.li2": "Інтеграція з основними системами компанії",
        "pricing.plan2.li3": "Пріоритетна підтримка під час запуску",
        "pricing.plan2.cta": "Зв'язатися з продажами",
        "pricing.plan2.ctaNote":
          "Допоможемо підібрати конфігурацію під вашу стратегію впровадження.",

        "pricing.plan3.label": "Для корпорацій і партнерів",
        "pricing.plan3.name": "Enterprise / OEM",
        "pricing.plan3.tagline":
          "Коли MITE стає ядром вашої цифрової інфраструктури.",
        "pricing.plan3.price": "Індивідуальна вартість",
        "pricing.plan3.note":
          "Для промислових лідерів та провайдерів галузевих рішень.",
        "pricing.plan3.li1": "Великомасштабні багатосайтові впровадження",
        "pricing.plan3.li2": "White-label та OEM-можливості",
        "pricing.plan3.li3": "Індивідуальні SLA та модель співпраці",
        "pricing.plan3.cta": "Запросити стратегічну сесію",

        // TESTIMONIALS
        "testimonials.eyebrow": "Відгуки",
        "testimonials.title": "«Просто, прозоро і справді працює»",
        "testimonials.subtitle":
          "Фідбек від команд, що цінують прогнозований результат більше, ніж список модних технологій.",
        "testimonials.quote1.text":
          "«Нам була потрібна платформа, яка не змушує мислити як розробники. В MITE ми описуємо процеси мовою експлуатації, а не коду.»",
        "testimonials.quote1.author": "Director of Operations",
        "testimonials.quote1.role": "Виробнича компанія",

        // FAQ
        "faq.eyebrow": "FAQ",
        "faq.title": "Питання, які поставлять IT та експлуатація",
        "faq.subtitle":
          "Коротко про інтеграції, безпеку і те, кому належать дані та логіка.",

        "faq.q1": "Як MITE інтегрується з нашими IT та OT системами?",
        "faq.a1":
          "Платформа має відкритий API та підтримує популярні промислові й веб-протоколи. Дані можна обмінювати з ERP, SCADA, MES, сховищами та внутрішніми застосунками.",

        "faq.q2": "Хто володіє конфігурацією та бізнес-логікою?",
        "faq.a2":
          "Ви. Логіка прозора й змінювана. Одна і та сама модель може слугувати основою для нових сценаріїв, партнерських рішень або майданчиків.",

        "faq.q3": "Чи підходить платформа для галузей з жорстким регулюванням?",
        "faq.a3":
          "Так. MITE розроблялася з урахуванням вимог до валідації, протоколювання змін та розподілу відповідальності.",

        // CONTACT
        "contact.eyebrow": "Контакти",
        "contact.title": "Знайдемо першу зрозумілу IIoT-перемогу",
        "contact.subtitle":
          "Опишіть інфраструктуру та бажаний ефект. Ми запропонуємо реалістичний перший крок і варіант масштабування.",
        "contact.nameLabel": "Повне ім'я",
        "contact.namePlaceholder": "Ваше ім'я",
        "contact.emailLabel": "Робочий e-mail",
        "contact.emailPlaceholder": "you@company.com",
        "contact.companyLabel": "Компанія",
        "contact.companyPlaceholder": "Назва компанії",
        "contact.sizeLabel": "Масштаб",
        "contact.sizePlaceholder": "Кількість майданчиків, ліній або активів",
        "contact.messageLabel": "Що ви хочете реалізувати з MITE?",
        "contact.messagePlaceholder":
          "Опишіть поточну ситуацію, задачі чи ідеї для сценаріїв.",
        "contact.submit": "Надіслати запит",
        "contact.legal":
          "Надсилаючи форму, ви погоджуєтеся на контакт щодо MITE та обробку даних згідно з політикою конфіденційності.",

        // FOOTER
        "footer.note":
          "MITE — промислова IoT-платформа для команд, що вимірюють ефект у грошах.",
