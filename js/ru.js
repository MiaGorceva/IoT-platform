...
window.translations.ru = {
  ...
  "useReal.subtitle":
    "Каждый сценарий — это конкретная проблема, её исполнение в MITE и измеримый результат. " +
"Без теории — только реальные процессы, которые можно запустить и масштабировать."",
  "uc.filter.all": "Все",
