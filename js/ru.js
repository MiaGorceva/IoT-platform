...
window.translations.ru = {
  ...
  "useReal.subtitle":
    "Сейчас — короткие карточки для доверия и ясности. Позже каждая из них может вырасти в отдельную страницу с полной механикой, подтверждающими материалами и скриншотами.",
