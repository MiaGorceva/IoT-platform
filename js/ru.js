...
window.translations.ru = {
  ...
  "hero.videoId": "pzveqhVl-zM",   // русская озвучка
  ...
  "useReal.promoEyebrow": "Обзор",
  "useReal.promoTitle": "От данных — к заданию, которое кто-то выполнит",
  "useReal.promoText":
    "Полторы минуты о том, что происходит между датчиком и человеком, который должен что-то сделать: единая модель данных, предиктив по тренду, поиск аномалий и задание исполнителю.",
  "useReal.promoCta": "Смотреть обзор",
  "useReal.promoHref": "https://youtu.be/_APdzkETn4M",
  ...
  "useReal.tutorialText":
    "Любой сценарий выше начинается одинаково: прибор нужно подключить и понять, что он отдаёт. "+
    "В ролике это показано целиком на реальном частотном приводе по Modbus — регистры, разрядность, параметры шины, живые значения.",
  "useReal.tutorialCta": "Смотреть пособие",
  "useReal.tutorialHref": "https://youtu.be/XzQMMNWm0y4",
  "uc.filter.all": "Все",
